...
export default function SelfieCheckTester({
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-white dark:bg-zinc-950">
      <div className="flex flex-col items-center gap-4 text-center max-w-sm w-full px-4">
        {environment !== "production" && <EnvironmentLogo environment={environment} size={64} />}
        <h1 className="text-2xl font-semibold">
          Selfie Check Tester
          {environment !== "production" && (
            <span className="block text-sm font-normal text-zinc-500 capitalize">
              {environment}
            </span>
          )}
        </h1>
